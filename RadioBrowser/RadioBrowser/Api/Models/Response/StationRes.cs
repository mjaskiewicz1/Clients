...
public record StationRes
{
    ...
    public required DateTimeOffset LastChangeTimeIso8601 { get; init; }
    ...
    [JsonPropertyName("hls")] public required bool Hls { get; init; }
    ...
    public required DateTimeOffset LastCheckTimeIso8601 { get; init; }
    ...
    public required DateTimeOffset LastCheckOkTimeIso8601 { get; init; }

    [JsonPropertyName("lastlocalchecktime")]
    public required DateTime LastLocalCheckTime { get; init; }

    [JsonPropertyName("lastlocalchecktime_iso8601")]
    public required DateTimeOffset LastLocalCheckTimeIso8601 { get; init; }

    [JsonPropertyName("clicktimestamp")] public required DateTime ClickTimestamp { get; init; }

    [JsonPropertyName("clicktimestamp_iso8601")]
    public required DateTimeOffset ClickTimestampIso8601 { get; init; }
